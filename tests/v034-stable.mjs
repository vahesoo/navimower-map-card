...
assert.equal(NAVIMOWER_MAP_CARD_V034_VERSION, "0.3.0");
...
for (const root of ["src", "dist"]) {
  ...
  const layer = readFileSync(`${root}/navimower-map-card-v034.js`, "utf8");
...
console.log("0.3.0 stable cache-safe native-color checks passed");
