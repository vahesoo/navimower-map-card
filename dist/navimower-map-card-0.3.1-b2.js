...
if (registration) {
  registration.description = "Navimower map with completed-session mowed areas, active live trail, retained-day history, account-scoped notification read controls, schedule editing, controls, and zoom.";
}
