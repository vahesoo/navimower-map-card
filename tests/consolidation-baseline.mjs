...
assert.ok(source.length <= 823461, `runtime grew during consolidation: ${source.length} chars`);
...
assert.ok(applyMapPayloadWrappers.length <= 4, `_applyMapPayload wrapper count grew: ${applyMapPayloadWrappers.length}`);
