...
assert.ok(
  pkg.version === "0.3.3",
  `expected stable 0.3.3, got ${pkg.version}`,
);
...
assert.match(source, /var NAVIMOWER_MAP_CARD_VERSION2 = "0\.3\.3";/);
...
console.log("0.3.3 stable single-runtime regression checks passed");
