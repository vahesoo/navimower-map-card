 ...
 * (0.3.1-b1, ..., 0.3.1-b5, ...) and stable will use 0.3.1.js.
 */
...
if (registration) {
  registration.description = "Navimower map with completed mowed areas, conditional retained-task Resume, compact account-scoped notifications, schedule editing, controls, and zoom.";
}
