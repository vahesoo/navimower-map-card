...
// beta23 extends the beta22 presentation transform with inverse viewport
// coverage and upright overlay compensation, still without a new runtime wrapper.
assert.ok(normalizedSource.length <= 898000, `runtime grew beyond beta23 feature budget: ${normalizedSource.length} normalized chars`);
