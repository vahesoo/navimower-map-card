...
assert.ok(source.length <= 826039, `runtime grew during consolidation: ${source.length} chars`);
...
assert.ok(setConfigWrappers.length <= 12, `setConfig wrapper count grew: ${setConfigWrappers.length}`);
