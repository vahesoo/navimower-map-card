...
// beta24 reorganizes the existing editor schema and adds capability-aware
// LiDAR editor visibility without adding another runtime wrapper.
assert.ok(normalizedSource.length <= 901000, `runtime grew beyond beta24 feature budget: ${normalizedSource.length} normalized chars`);
