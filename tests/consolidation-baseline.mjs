...
assert.ok(source.length <= 825766, `runtime grew during consolidation: ${source.length} chars`);
...
assert.ok(setConfigWrappers.length <= 11, `setConfig wrapper count grew: ${setConfigWrappers.length}`);
