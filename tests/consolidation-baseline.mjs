...
assert.ok(source.length <= 825172, `runtime grew during consolidation: ${source.length} chars`);
...
assert.ok(ensureDomWrappers.length <= 9, `_ensureDom wrapper count grew: ${ensureDomWrappers.length}`);
