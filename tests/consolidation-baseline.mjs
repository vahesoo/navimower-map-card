...
assert.ok(source.length <= 826721, `runtime grew during consolidation: ${source.length} chars`);
...
assert.ok(ensureDomWrappers.length <= 12, `_ensureDom wrapper count grew: ${ensureDomWrappers.length}`);
