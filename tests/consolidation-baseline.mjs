...
assert.ok(source.length <= 790026, `runtime grew during consolidation: ${source.length} chars`);
assert.ok(sourceSections.length <= 7, `source section count grew: ${sourceSections.length}`);
