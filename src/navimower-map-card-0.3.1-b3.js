 ...
 * (0.3.1-b1, 0.3.1-b2, 0.3.1-b3, ...) and stable will use 0.3.1.js.
 */
...
if (registration) {
  registration.description = "Navimower map with mowed-area history, compact account-scoped notifications, two-row header, schedule editing, mower controls, and zoom.";
}
