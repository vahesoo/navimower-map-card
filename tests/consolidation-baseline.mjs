...
assert.ok(source.length <= 823394, `runtime grew during consolidation: ${source.length} chars`);
...
assert.ok(applyMapPayloadWrappers.length <= 3, `_applyMapPayload wrapper count grew: ${applyMapPayloadWrappers.length}`);
