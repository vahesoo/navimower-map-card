...
// beta25 removes obsolete YAML aliases and pagination/underlay compatibility
// branches without adding another runtime wrapper.
assert.ok(normalizedSource.length <= 897000, `runtime grew beyond beta25 cleanup budget: ${normalizedSource.length} normalized chars`);
