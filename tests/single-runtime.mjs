...
assert.ok(pkg.version === "0.3.4-beta6", `expected 0.3.4-beta6, got ${pkg.version}`);
...
assert.match(source, /var NAVIMOWER_MAP_CARD_VERSION2 = "0\.3\.4-beta6";/);
assert.match(source, /0\.3\.4-beta5: scheduler overview and configurable settings dialog/);
assert.match(source, /0\.3\.4-beta6: schedule source, custom queue and inline settings/);
...
console.log("0.3.4-beta6 single-runtime regression checks passed");
