...
assert.ok(source.length <= 818166, `runtime grew during consolidation: ${source.length} chars`);
...
assert.ok(renderHistoryWrappers.length <= 4, `_renderHistory wrapper count grew: ${renderHistoryWrappers.length}`);
