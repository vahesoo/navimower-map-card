...
assert.ok(source.length <= 826175, `runtime grew during consolidation: ${source.length} chars`);
...
assert.ok(setConfigWrappers.length <= 13, `setConfig wrapper count grew: ${setConfigWrappers.length}`);
