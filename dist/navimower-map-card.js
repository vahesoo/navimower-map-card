...
const NAVIMOWER_MAP_CARD_VERSION = "0.3.0-beta1";
...
if (registration) {
  registration.description = "Navimower map with compact completed-session mowed areas, an active live trail, retained-day history, controls, schedule editing, and zoom.";
}
