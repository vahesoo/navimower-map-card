...
assert.ok(source.length <= 825509, `runtime grew during consolidation: ${source.length} chars`);
...
assert.ok(ensureDomWrappers.length <= 10, `_ensureDom wrapper count grew: ${ensureDomWrappers.length}`);
